...
6. Import the world in your workspace (/workspace/turtlebot_env/world)
7. Import the launch file in your workspace (/workspace/turtlebot_env/launch)
...
10. Use **2D Nav Goal** in RViz to select the goal.

11.  Moving!

12.  You can use the other script to shutdown them rapidly.
    ```bash
    ./killpro.sh
    ```
